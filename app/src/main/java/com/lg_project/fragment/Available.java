...
import com.lg_project.modelclass.AnimalNames;
...
public class Available extends Fragment implements SearchView.OnQueryTextListener {
    private String customer_id = "",body="",race="",hair="", hairID="0";
    CustomAdapter customAdapter;
    SearchView editsearch;
    ImageView nodata,filter;
    RecyclerView recyclerView;
    ArrayList<ContactorModel> arraylist = new ArrayList<ContactorModel>();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        MainActivity2.heading.setText(getResources().getString(R.string.contractors));
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        Log.e("id", String.valueOf(customer_id));

        data = new ArrayList<>();
        for (int i = 0; i < data.size(); i++) {
            Log.d("DATA", data.get(i).getFirstName());
        }
        ...
        EditText searchEditText = (EditText) editsearch.findViewById(R.id.search_src_text);
...
//
        ...
        rangeSeekbar_Height.setOnRangeSeekbarChangeListener(new OnRangeSeekbarChangeListener() {
            ...
            public void valueChanged(Number minValue, Number maxValue) {
                ...
                double min = ((float) Double.parseDouble(String.valueOf(minValue)));
                Double prgrs = min;
                double max = ((float) Double.parseDouble(String.valueOf(maxValue)));
...
//                Log.d("COUN", String.valueOf(response.body().getMessage()));
                ...
                try {
                    if (response.errorBody() != null) {
                        ...
                        for (int i = 0; i < data.size(); i++) {
                            if (data.get(i).getStatus().equals("Available")) {
                                Log.d("RERERE", data.get(i).getFirstName());
